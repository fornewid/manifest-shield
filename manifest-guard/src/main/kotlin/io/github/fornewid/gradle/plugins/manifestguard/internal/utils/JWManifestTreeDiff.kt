...
@JvmName("diff")
internal fun dependencyTreeDiff(old: String, new: String): String {
    val oldPaths = findManifestPaths(old)
    val newPaths = findManifestPaths(new)
...
private fun findManifestPaths(text: String): Set<List<String>> {

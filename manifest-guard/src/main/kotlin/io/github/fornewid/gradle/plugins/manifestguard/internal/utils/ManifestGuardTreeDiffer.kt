...
internal class ManifestGuardTreeDiffer(
    ...
    companion object {
        fun projectDirOutputFile(projectDirectory: Directory, configurationName: String): File =
            OutputFileUtils.projectDirOutputFile(
                ...
                reportType = ManifestGuardReportType.TREE,
            )
    ...
    fun performDiff() {
        ...
        if (shouldBaseline || baseline == null) {
            ...
            ColorTerminal.printlnColor(
                ...
                "Manifest Guard Tree baseline created for $projectPath for configuration $configurationName."
            )
            ColorTerminal.printlnColor(
                ColorTerminal.ANSI_YELLOW,
            ...
            if (diff.isNotBlank()) {
                ...
                throw GradleException(
                    """
                        ...
                        Manifest Tree comparison to baseline does not match.
